...
class AppStateNotifier extends ChangeNotifier {
  DeloreanFirebaseUser? initialUser;
  DeloreanFirebaseUser? user;
  ...
  void update(DeloreanFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'ManualHello',
              path: 'manualHello',
              builder: (context, params) => ManualHelloWidget(),
            ),
            FFRoute(
              name: 'ManualAuto',
              path: 'manualAuto',
              builder: (context, params) => ManualAutoWidget(),
            ),
            FFRoute(
              name: 'ManuaLOpenFinance',
              path: 'manuaLOpenFinance',
              builder: (context, params) => ManuaLOpenFinanceWidget(),
            ),
            FFRoute(
              name: 'ManuaLGPD',
              path: 'manuaLGPD',
              builder: (context, params) => ManuaLGPDWidget(),
            ),
            FFRoute(
              name: 'ManuaPartner',
              path: 'manuaPartner',
              builder: (context, params) => ManuaPartnerWidget(),
            ),
            FFRoute(
              name: 'Acordo',
              path: 'acordo',
            ...
            FFRoute(
              name: 'OpenFinance',
              path: 'openFinance',
              builder: (context, params) => OpenFinanceWidget(),
            )
